 ...
 */
public class ajaxgwt implements EntryPoint {
	/**
	...
	public void onModuleLoad() {
		...
		RootPanel.get("errorLabelContainer").add(response);
		...
		class MyHandler implements ClickHandler, KeyUpHandler {
			...
			private void sendNameToServer() {
				...
				helloService.sayHello(textToServer, callback);
				/*
